  ...
  return (
    <AlertDialog.Portal>
      <AlertDialog.Overlay className='bg-black/60 inset-0 fixed'>
        ...
        <AlertDialog.Content className='fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-black/25'>
          <AlertDialog.Title className='text-3xl font-black'>
            Publique um anúncio
          </AlertDialog.Title>
          ...
          <form className='mt-8 flex flex-col gap-4' onSubmit={handleCreateAd}>
            ...
            <div className='grid grid-cols-2 gap-6'>
              ...
              <div className='flex flex-col gap-2'>
                ...
                <Input type="text" placeholder="User#0000" name="discord" id="discord" />
              </div>
            </div>
